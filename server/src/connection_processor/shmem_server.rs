pub mod memoryprocessor {
    ...
    pub fn fill_sh_memory(key: String, value: String, serial_msg: u32) {
        ...
        unsafe {
            ...
            println!("data: {:?}", buf_struct);
            std::ptr::copy(bytes.as_ptr(), ptr_cpy, sizeofstruct);
            ptr_cpy = ptr_cpy.add(sizeofstruct); // increment pointer
        }
        ...
        unsafe {
            ...
            raw_ptr = raw_ptr.add(mem::size_of::<u32>()); // add 4 bytes
        }
    }
